      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo base_url('admin/dashboard') ?>">ADMIN PANEL</a>
          </div>
          ...
          <ul class="sidebar-menu">
              ...
              <li class="<?php echo (strpos(current_url(), "admin/data_ps") !== false) ? "active" : ""?>"><a class="nav-link" href="<?php echo base_url('admin/data_ps') ?>"><i class="fas fa-gamepad"></i> <span>Data ps</span></a></li>
              ...
              <li class="<?php echo (strpos(current_url(), "admin/contact") !== false) ? "active" : ""?>"><a class="nav-link" href="<?php echo base_url('admin/contact') ?>"><i class="fas fa-comment"></i> <span>Pesan Pelanggan</span></a></li>
