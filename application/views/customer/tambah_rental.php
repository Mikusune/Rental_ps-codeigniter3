	...
	<div class="card" style="margin-top: 170px; margin-bottom: 50px">
		...
		<div class="card-body">
			<?php foreach($detail as $dt) : ?>
				<!-- <span style="font-size: 1.2em;">ps <?php echo $dt->nama_type ?> dengan Merk <?php echo $dt->merk ?> ini disediakan oleh Perusahaan Rental <?php echo $dt->nama_rental ?>.</span>
				<hr> -->
				<form method="POST" action="<?php echo base_url('customer/rental/tambah_rental_aksi') ?>">
					...
					<div class="form-group">
						...
						<input type="hidden" name="id_ps" value="<?php echo $dt->id_ps ?>">
