...
class Dashboard extends CI_Controller {
	...
	public function index()
	{
		...
		$config['total_rows'] 	= $this->ps_model->count_ps();
		$config['per_page'] 	= 3;
		...
		$data['title'] = "Rental ps";
		$data['ps'] = $this->ps_model->get_data2($config['per_page'] ,$data['page'])->result();
		$data['pagination'] = $this->pagination->create_links();
		$data['testimonial'] = $this->testimonial_model->tampil_data('testimonial')->result();
		$this->load->view("templates_rental_ps/header",$data);
		$this->load->view("home/home");
		$this->load->view("templates_rental_ps/footer");		
	}
