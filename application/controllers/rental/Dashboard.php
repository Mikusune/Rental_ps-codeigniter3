<?php
	...
	class Dashboard extends CI_Controller{
		...
		public function index(){
			...
			$data['transaksi']	= $this->db->query("SELECT * FROM transaksi tr, ps mb, customer cs WHERE tr.id_ps=mb.id_ps AND tr.id_customer=cs.id_customer AND tr.status_pembayaran='0' AND tr.nama_rental = '$nama_rental'")->result();
